...
const DataConnectionPage = ({ onBackToDashboard }) => {
  ...
  const dataSources = [
    ...
    { 
      ...
      description: 'Browse OneLake data', 
      color: '#5e5ce6' 
    },
    { 
      id: 'excel', 
    ...
    { 
      id: 'paste', 
      name: 'Paste or manually enter data', 
    ...
    { 
      id: 'semantic', 
      name: 'Pick a published semantic model', 
      icon: <FiBookOpen size={28} />,
      description: 'Use existing model', 
      color: '#0078d4' 
    }
  ];
  ...
  const otherItems = [
    {
      ...
      description: 'Store big data for cleaning, querying, reporting, and sharing.'
    },
    {
      id: 'notebook',
      name: 'Notebook',
      icon: <FiBook size={28} />,
      description: 'Explore, analyze, and visualize data and build ML models.'
    }
  ];
        ...
        <div className="dataconnection-container">
          ...
          <div className="datasources-grid">
            {dataSources.map(source => (
              <div
                key={source.id}
                className={`datasource-card ${source.isPrimary ? 'primary' : ''}`}
                onClick={() => alert(`Connect to ${source.name}`)}
              >
                <div className="datasource-icon" style={{ color: source.color }}>
                  {source.icon}
                </div>
          ...
          <div className="info-section">
            <p className="info-text">
              💡 Don't see the source you're looking for? <a href="#">Download the desktop app</a>
            </p>
            <p className="info-text old-experience">
              Looking for the old experience? <a href="#">Excel</a> or <a href="#">CSV</a>. 
              These old experiences will be deprecated soon. <a href="#">Learn more</a>
            </p>
          </div>
          ...
          <div className="other-items-section">
            ...
            <p className="workspace-info">
              Current workspace: <strong>My workspace</strong> <a href="#" className="change-link">(Change)</a>
              <br />
            ...
            <div className="items-grid">
              {otherItems.map(item => (
                <div key={item.id} className="item-card" onClick={() => alert(`Create ${item.name}`)}>
                  <div className="item-icon" style={{ color: '#01b8aa' }}>
                    {item.icon}
                  </div>
